      ...
      <div className="flex-1 flex flex-col sm:flex-row items-center justify-center w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-0 sm:pt-8 pb-30 gap-0 sm:gap-6">
        ...
        <div className="w-full sm:w-1/2 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-center text-center w-full md:w-auto">
            <Link
              to="/auth/login"
              className="w-full md:w-auto sm:text-xl sm:px-7 px-5 py-2.5 rounded-md bg-orange-500 text-white no-underline font-semibold shadow-[0_4px_0_0_#c2410c]
            ...
            <Link
              to="/auth/register"
              className="w-full md:w-auto sm:text-xl sm:px-5 border-2 border-orange-500 px-4 py-2.5 rounded-md bg-white text-orange-500 font-semibold no-underline
